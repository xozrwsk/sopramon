...
public class Affichage {
	...
	static void choix() {
		...
		while (erreur) {
			try {
				...
				System.out.println("Vous �tes bien connect� avec votre Sopramon :" + s.getNom());
				menu();
			} catch (Exception e) {
				erreur = false;
				System.err.println("==== > Identifiants et/ou mots de passe �rron�(s) <==== ");
				choix();
			}
		}
	}
	...
	static void menu() {
		...
		while (q < 1 || q > 7) {
			...
			System.out.println("1. S'inscrire et cr�er un Sopramon");
	...
	static void findAll() {
		...
		for (Sopramon s : daoSopramon.findAll()) {
			...
			System.out.println("Exp�rience : " + s.getExperience());
	...
	static void save() {
		...
		System.out.println("Choisir un pr�nom d'utilisateur :");
		String b = lireChaine();
	...
	static void creerItem() {
		...
		System.out.println("Caract�ristique d'attaque :");
		int d = lireEntier();
		nouveauItem.setAttaque(d);

		System.out.println("Caract�ristique de d�fense :");
		int e = lireEntier();
		nouveauItem.setDefense(e);

		System.out.println("Caract�ristique de vitesse :");
		int f = lireEntier();
		nouveauItem.setVitesse(f);

		System.out.println("Caract�ristique d'esquive :");
		int g = lireEntier();
	...
	static void listerItem() {
		...
		do {
			...
			System.out.println("D�fense : " + j.getDefense());
